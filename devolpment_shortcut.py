...
def retrive_data(refresh_token: str, token: str, name: str) -> None:
    ...
    if button == True:
        # Look to load user cookies from file if they are saved
        with open("cookies.pk1", "rb") as f:
        ...
        # Save user cookies to a file to load later
        cookies = driver.get_cookies()
        with open("cookies.pk1", "wb") as f:
